...
You are invited to perform MAP-Bayesian estimation with your own models. These model files should be slightly modified in order to be "read" by mapbayr with the subsequent specifications: 
