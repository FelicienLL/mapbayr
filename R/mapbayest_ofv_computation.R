...
#' @param iddata,idDV,idcmt generated by \code{\link{preprocess.ofv.id}}
#' @param argofv above mentionned arguments as a list
#' @param ... for compatibility (not used)
#'
#' @details
...
#' @export
compute_ofv <- function(eta, qmod, sigma, omega_inv, all_cmt, log_transformation, iddata, idDV, idcmt, ...){
  #Update ETA values
  qmod <- qparam(x = qmod, p = eta)

  #Predict concentrations
  pred <- f(qmod = qmod, iddata = iddata)
